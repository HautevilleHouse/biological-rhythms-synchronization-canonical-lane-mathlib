...
def ConstrainedSynchronizationClosure (A : AdmissibleClass) : Prop :=
  bridgeClosed A ∧ gateClosed A

theorem constrained_synchronization_closure (A : AdmissibleClass) :
    ConstrainedSynchronizationClosure A := by
  unfold ConstrainedSynchronizationClosure
